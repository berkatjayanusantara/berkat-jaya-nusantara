            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form action="{{ route('penjualan.store') }}" method="POST" id="formPenjualan">
                    ...
                    <div class="flex justify-end gap-2 mt-6">
                        <a href="{{ route('penjualan.index') }}" class="px-4 py-2 bg-gray-200 text-gray-700 rounded-md hover:bg-gray-300">Batal</a>
                        <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700" onclick="return confirm('Simpan transaksi penjualan ini? Stok barang akan berkurang otomatis.')">Simpan Penjualan</button>
                    </div>
                </form>
            </div>
        </div>
