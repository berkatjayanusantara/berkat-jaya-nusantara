    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-4 p-4 bg-yellow-50 border border-yellow-200 text-yellow-800 rounded-md">
                <strong>Catatan:</strong> Invoice penjualan lama akan disimpan sebagai data historis dan <strong>tidak akan mengurangi stok barang</strong>. Jika metode pembayaran kredit, sistem tetap membuat data piutang.
            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                        <div>
                            ...
                            <p class="text-sm text-gray-500 mt-1">
                                Nomor sistem dibuat otomatis, bukan nomor invoice utama.
                            </p>
                        </div>
                        ...
                        <div class="bg-gray-50 p-4 rounded-md border">
                            <div class="mb-4">
                                ...
                                <select name="mode_ppn"
                                    ...
                                    class="w-full border-gray-300 rounded-md shadow-sm"
                                    required>
                                    <option value="tanpa_ppn" {{ old('mode_ppn') === 'tanpa_ppn' ? 'selected' : '' }}>
                                        Tidak Pakai PPN
                                    </option>
                                    <option value="include" {{ old('mode_ppn', 'include') === 'include' ? 'selected' : '' }}>
                                        Harga Sudah Termasuk PPN
                                    </option>
                                    <option value="exclude" {{ old('mode_ppn') === 'exclude' ? 'selected' : '' }}>
                                ...
                                <div id="detailFakturPajak" class="mt-4 space-y-3 hidden">
                                    ...
                                    <div>
                                        ...
                                        <input type="date"
                                            ...
                                            value="{{ old('tanggal_faktur_pajak') }}"
                                            class="w-full border-gray-300 rounded-md shadow-sm">
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <textarea name="alamat_faktur_pajak"
                                            ...
                                            rows="3"
                                            class="w-full border-gray-300 rounded-md shadow-sm"
                                            placeholder="Alamat sesuai kebutuhan faktur pajak">{{ old('alamat_faktur_pajak') }}</textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mt-4 mb-4 p-3 bg-white rounded border">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                                    <div>
                                        ...
                                        <select name="jenis_penyesuaian_total"
                                            ...
                                            class="w-full border-gray-300 rounded-md shadow-sm">
                                            <option value="tidak_ada" {{ old('jenis_penyesuaian_total', 'tidak_ada') === 'tidak_ada' ? 'selected' : '' }}>
                                                Tidak Ada
                                            </option>
                                            <option value="tambah" {{ old('jenis_penyesuaian_total') === 'tambah' ? 'selected' : '' }}>
                                                Tambah Total Akhir
                                            </option>
                                            <option value="kurang" {{ old('jenis_penyesuaian_total') === 'kurang' ? 'selected' : '' }}>
                                                Kurangi Total Akhir
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input type="number"
                                            ...
                                            value="{{ old('nominal_penyesuaian_total', 0) }}"
                                            min="0"
                                            step="0.01"
                                ...
                                <div class="mt-3">
                                    ...
                                    <textarea name="keterangan_penyesuaian_total"
                                        ...
                                        rows="2"
                                        class="w-full border-gray-300 rounded-md shadow-sm"
                                        placeholder="Contoh: pengurangan karena isi botol dalam 1 dus kurang, pembulatan harga, tambahan biaya lain">{{ old('keterangan_penyesuaian_total') }}</textarea>
                                </div>
